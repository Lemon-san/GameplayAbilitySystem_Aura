...
//typedef is specific to the FGameplayAttribute() signature but TStaticFunc can use any signature
...
public:
	...
	*/
	...
	UFUNCTION()
	void OnRep_ArmorPenetration(const FGameplayAttributeData& OldArmorPen) const;
	...
	UFUNCTION()
	void OnRep_CritHitDamage(const FGameplayAttributeData& OldCritDamage) const;

	UFUNCTION()
	void OnRep_CritHitResistance(const FGameplayAttributeData& OldCritResistance) const;
	...
	UFUNCTION()
	void OnRep_LightningResistance(const FGameplayAttributeData& OldLightningRes) const;

	UFUNCTION()
	void OnRep_ArcaneResistance(const FGameplayAttributeData& OldArcaneRes) const;
